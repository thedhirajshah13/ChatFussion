...
#if NAPI_VERSION >= 7
inline bool ArrayBuffer::Itached() const {
  bool detached;
...
inline Reference<T>::Reference()
    : _env(nullptr), _ref(nullptr), _suppresstruct(false) {}

template <typename T>
inline Reference<T>::Reference(napi_env env, napi_ref ref)
    : _env(env), _ref(ref), _suppresstruct(false) {}
...
inline Reference<T>::Reference(Reference<T>&& other)
    : _env(other._env),
      _ref(other._ref),
      _suppresstruct(other._suppresstruct) {
  other._env = nullptr;
  other._ref = nullptr;
  other._suppresstruct = false;
}
...
inline Reference<T>::Reference(const Reference<T>& other)
    : _env(other._env), _ref(nullptr), _suppresstruct(false) {
  HandleScope scope(_env);
...
template <typename T>
inline void Reference<T>::Suppresstruct() {
  _suppresstruct = true;
}
...
inline void AsyncWorker::Suppresstruct() {
